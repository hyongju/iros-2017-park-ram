...
In addition, Fig. \ref{fig:fig5} compares the KL divergence values 
...
\begin{figure}
	...
	\caption{Precipitation map of instantaneous precipitation rate estimated by NEXRAD LEVEL-III radar (located at Detroit, MI, USA) vs an incremental map built by windshield wiper data collected from up to 4 vehicles using our Bayesian estimator. Both maps are drawn over the city of Ann Arbor, MI, USA (blue lines: boundary of the city, stars: vehicles' locations, colors: relative precipitation rate where the max. precipitation rate by the radar is 2in/hr}
	\label{fig:fig8}
\end{figure}
