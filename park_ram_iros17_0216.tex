...
\label{sec:sec6}
We consider the Particle Filtering approach to reduce the complexity of the target map evolution \Ram{how is the target map evolving? I thought it was fixed...?I think you mean the reconstruction is being updated as observations appear...}. 
